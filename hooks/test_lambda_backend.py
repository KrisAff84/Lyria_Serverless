# Turn this into a Lambda Function eventually
import json
import boto3
...
session = boto3.session.Session(profile_name='kris84', region_name=region_name)
...
def main():
    bucket_name = 'lyria-storage-2024-dev'
